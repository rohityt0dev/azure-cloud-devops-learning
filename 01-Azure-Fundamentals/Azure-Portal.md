...
After creation, explore the resource's configuration and monitoring options.

---

## Exercise 4 — Explore Azure Monitor

Open Azure Monitor and explore:
...
Understand how monitoring helps identify resource and application issues.

---

## Exercise 5 — Use Cloud Shell
...
Explore the output and compare CLI management with the graphical Azure Portal.
